...
-- Create a new function with simpler rating handling
...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            ...
            ELSE NULL
        END as distance_km,
        -- Rating conversion - simplified approach
        CASE 
            WHEN l.rating IS NOT NULL THEN 
                CASE 
                    WHEN l.rating::TEXT = '' THEN 0
                    ELSE COALESCE(
                        CASE 
    ...
    WHERE 
        ...
        -- Rating filters - simplified approach
    ...
    ORDER BY 
        CASE 
            ...
            WHEN sort_by = 'rating' THEN 
                CASE 
                    WHEN l.rating IS NOT NULL AND l.rating::TEXT ~ '^[0-9]+\.?[0-9]*$' THEN -l.rating::TEXT::DOUBLE PRECISION
                    ELSE 0 
                END
