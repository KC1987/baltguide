...
export default function LocationCard({ data }:any) {
  ...
  return (
    <Card className="max-w-sm" >
      ...
      <Divider />
      <CardBody>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Mollitia, qui animi, quaerat sapiente sed necessitatibus consequuntur pariatur doloremque quidem odit vero nostrum saepe perspiciatis quas, soluta consectetur aut. Dolorem, ex.</p>
      </CardBody>
      <Divider />
